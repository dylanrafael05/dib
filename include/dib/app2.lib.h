...
namespace dib::app2
{
    ...
    public:
        ...
        dib::strings::string_literal name;
        dib::strings::string_literal parent;
        dib::strings::string_literal order;
        bool order_is_before = false;

        bool is_persistent() const {return persistent;}
        void mark_persistent();

        System in_group(dib::strings::string_literal) &&;
        System order_after(dib::strings::string_literal) &&;
        System order_before(dib::strings::string_literal) &&;
        System run_if(PredicateCallback &&) &&;

        static System simple(dib::strings::string_literal name, Callback &&function);
        static System group(dib::strings::string_literal name, Callback &&prefix = nullptr, Callback &&suffix = nullptr);
    };
